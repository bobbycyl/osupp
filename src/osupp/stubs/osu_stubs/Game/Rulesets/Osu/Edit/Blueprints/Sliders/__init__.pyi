...
from osu.Framework.Input.Events import DragStartEvent
...
from osu.Game.Rulesets.Osu.Edit.Blueprints import OsuSelectionBlueprint
...
class SliderCircleOverlay(CompositeDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, slider: Slider, position: SliderPosition):
        """
    ...
    def EdgeEffect(self) -> EdgeEffectParameters:
        """"""
    @property
    def EndDragMarker(self) -> SliderEndDragMarker:
        """
    ...
    def Transforms(self) -> IEnumerable[Transform]:
        """"""
    @property
    def VisibleQuad(self) -> RectangleF:
        """
    ...
    """"""
class SliderEndDragMarker(SmoothPath, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IBufferedDrawable, IDrawable, ITexturedShaderDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    ...
    def DisposeOnDeathRemoval(self) -> bool:
        """"""
    @property
    def Drag(self) -> Action[DragEvent]:
        """
        
        :return: 
        """
    @Drag.setter
    def Drag(self, value: Action[DragEvent]) -> None: ...
    @property
    def DragBlocksClick(self) -> bool:
        """"""
    @property
    ...
    def DrawWidth(self) -> float:
        """"""
    @property
    def EndDrag(self) -> Action:
        """
        
        :return: 
        """
    @EndDrag.setter
    def EndDrag(self, value: Action) -> None: ...
    @property
    def FillAspectRatio(self) -> float:
        """"""
    @FillAspectRatio.setter
    ...
    def Size(self, value: Vector2) -> None: ...
    @property
    def StartDrag(self) -> Action[DragStartEvent]:
        """
        
        :return: 
        """
    @StartDrag.setter
    def StartDrag(self, value: Action[DragStartEvent]) -> None: ...
    @property
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class SliderPlacementBlueprint(HitObjectPlacementBlueprint, ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class SliderPosition(Enum):
    """"""
    Start: SliderPosition = ...
    """"""
    End: SliderPosition = ...
    """"""
class SliderSelectionBlueprint(OsuSelectionBlueprint[Slider], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IStateful[SelectionState]):
    """"""
