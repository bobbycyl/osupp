...
class HitCircleOverlapMarker(BlueprintPiece[HitCircle], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    FADE_OUT_EXTENSION: Final[ClassVar[float]] = ...
    """
    ...
    def TriggerEvent(self, e: UIEvent) -> bool:
        """"""
    def UpdateFrom(self, hitObject: HitCircle) -> None:
        """
    ...
    """"""
class HitCirclePiece(BlueprintPiece[HitCircle], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
