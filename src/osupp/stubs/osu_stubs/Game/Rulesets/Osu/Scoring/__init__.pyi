...
from osu.Game.Rulesets.Scoring import DrainingHealthProcessor
...
class OsuHealthProcessor(DrainingHealthProcessor, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
...
class OsuHitWindows(HitWindows):
    """"""
    GREAT_WINDOW_RANGE: Final[ClassVar[DifficultyRange]] = ...
    """
    
    :return: 
    """
    MEH_WINDOW_RANGE: Final[ClassVar[DifficultyRange]] = ...
    """
    
    :return: 
    """
    MISS_WINDOW: Final[ClassVar[float]] = ...
    """
    
    :return: 
    """
    OK_WINDOW_RANGE: Final[ClassVar[DifficultyRange]] = ...
    """
    ...
    def WindowFor(self, result: HitResult) -> float:
        ...
        :return: 
        """
class OsuLegacyHealthProcessor(LegacyDrainingHealthProcessor, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Health: Final[BindableDouble] = ...
    """
    ...
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, drainStartTime: float):
        """
