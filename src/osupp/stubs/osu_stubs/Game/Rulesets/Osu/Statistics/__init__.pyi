...
class AccuracyHeatmap(CompositeDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, score: ScoreInfo, playableBeatmap: IBeatmap):
        """
    ...
    def Expire(self, calculateLifetimeStart: bool = ...) -> None:
        """"""
    @classmethod
    def FindRelativeHitPosition(cls, previousObjectPosition: Vector2, nextObjectPosition: Vector2, hitPoint: Vector2, objectRadius: float, rotation: float) -> Vector2:
        """
        
        :param previousObjectPosition: 
        :param nextObjectPosition: 
        :param hitPoint: 
        :param objectRadius: 
        :param rotation: 
        :return: 
