...
from osu.Game.Rulesets.Mania.Objects import Note
...
class HoldNotePlacementBlueprint(ManiaPlacementBlueprint[HoldNote], ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    ...
    """"""
class HoldNoteSelectionBlueprint(ManiaSelectionBlueprint[HoldNote], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IStateful[SelectionState]):
    """"""
    ...
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, hold: HoldNote):
        """
    ...
    """"""
class ManiaPlacementBlueprint(ABC, Generic[T], HitObjectPlacementBlueprint, ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    HitObject: Final[HitObject] = ...
    """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class ManiaSelectionBlueprint(ABC, Generic[T], HitObjectSelectionBlueprint[T], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IStateful[SelectionState]):
    """"""
    Item: Final[HitObject] = ...
    """
    ...
    StateChanged: EventType[Action[SelectionState]] = ...
    """"""
class NotePlacementBlueprint(ManiaPlacementBlueprint[Note], ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    HitObject: Final[HitObject] = ...
    """
    ...
    def UpdateSubTreeMasking(self) -> bool:
        """"""
    def UpdateTimeAndPosition(self, screenSpacePosition: Vector2, referenceTime: float) -> SnapResult:
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class NoteSelectionBlueprint(ManiaSelectionBlueprint[Note], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IStateful[SelectionState]):
    """"""
    Item: Final[HitObject] = ...
    """
