...
from osu.Game.Rulesets.Edit.Checks import CheckConcurrentObjects
...
class CheckKeyCount(Object, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    def ToString(self) -> str:
        """"""
    class IssueTemplateKeycountTooLow(IssueTemplate):
        """"""
        Check: Final[ICheck] = ...
        """
        ...
        def Colour(self) -> Colour4:
            ...
            :return: 
            """
        def Create(self, current: float) -> Issue:
            """"""
        def Equals(self, obj: object) -> bool:
            """"""
        def GetHashCode(self) -> int:
        ...
        def ToString(self) -> str:
            """"""
class CheckManiaAbnormalDifficultySettings(CheckAbnormalDifficultySettings, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    def ToString(self) -> str:
        """"""
class CheckManiaConcurrentObjects(CheckConcurrentObjects, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    def ToString(self) -> str:
        """"""
class CheckManiaLowestDiffDrainTime(CheckLowestDiffDrainTime, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
