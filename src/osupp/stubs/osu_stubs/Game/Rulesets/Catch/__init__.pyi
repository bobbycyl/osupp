...
class CatchAction(Enum):
    """"""
    MoveLeft: CatchAction = ...
    """"""
    MoveRight: CatchAction = ...
    """"""
    Dash: CatchAction = ...
    """"""
class CatchInputManager(RulesetInputManager[CatchAction], ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IInputStateChangeHandler, IFocusManager, IRequireHighFrequencyMousePosition, ISourceGeneratedHandleInputCache, ICanAttachHUDPieces, IHasRecordingHandler, IHasReplayHandler):
    """"""
    CurrentState: Final[InputState] = ...
    """"""
    KeyBindingContainer: Final[KeyBindingContainer[CatchAction]] = ...
    """
    ...
    """"""
class CatchRuleset(Ruleset, ILegacyRuleset):
    """"""
    ...
    def ToString(self) -> str:
        """"""
class CatchSkinComponentLookup(SkinComponentLookup[CatchSkinComponents], ISkinComponentLookup):
    """"""
    Component: Final[CatchSkinComponents] = ...
    """
    
    :return: 
    """
    def __init__(self, component: CatchSkinComponents):
        """
    ...
    def ToString(self) -> str:
        """"""
class CatchSkinComponents(Enum):
    """"""
    Fruit: CatchSkinComponents = ...
    """"""
    Banana: CatchSkinComponents = ...
    """"""
    Droplet: CatchSkinComponents = ...
    """"""
    Catcher: CatchSkinComponents = ...
    """"""
    CatchComboCounter: CatchSkinComponents = ...
    """"""
    HitExplosion: CatchSkinComponents = ...
    """"""