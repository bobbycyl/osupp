...
class CatchBeatmap(Beatmap[CatchHitObject], IBeatmap, IBeatmap[CatchHitObject]):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    @property
    def HitObjects(self) -> List[CatchHitObject]:
        """
        
        :return: 
        """
    @HitObjects.setter
    def HitObjects(self, value: List[CatchHitObject]) -> None: ...
    @property
    ...
    def Clone(self) -> Beatmap[CatchHitObject]:
        """
    ...
    def GetMostCommonBeatLength(self) -> float:
        ...
        """
    @classmethod
    def GetPalpableObjects(cls, hitObjects: IEnumerable[HitObject]) -> IEnumerable[PalpableCatchHitObject]:
        """
    ...
    def ToString(self) -> str:
        """"""
class CatchBeatmapConverter(BeatmapConverter[CatchHitObject], IBeatmapConverter):
    """"""
    ...
    """"""
class CatchBeatmapProcessor(BeatmapProcessor, IBeatmapProcessor):
    """"""
    RNG_SEED: Final[ClassVar[int]] = ...
    """
    ...
    def Beatmap(self) -> IBeatmap:
        ...
        """
    @property
    def HardRockOffsets(self) -> bool:
        """
        
        :return: 
        """
    @HardRockOffsets.setter
    def HardRockOffsets(self, value: bool) -> None: ...
    def ApplyPositionOffsets(self, beatmap: IBeatmap) -> None:
        """
