...
class ManiaAutoGenerator(AutoGenerator[ManiaReplayFrame]):
    """"""
    RELEASE_DELAY: Final[ClassVar[float]] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class ManiaFramedReplayInputHandler(FramedReplayInputHandler[ManiaReplayFrame], IDisposable, IHasDescription):
    """"""
    ...
    def __init__(self, replay: Replay):
        ...
        """
    @property
    def CurrentFrame(self) -> ManiaReplayFrame:
        """
    ...
    def Enabled(self) -> BindableBool:
        """"""
    @property
    def EndFrame(self) -> ManiaReplayFrame:
        """
    ...
    def IsActive(self) -> bool:
        """"""
    @property
    def NextFrame(self) -> ManiaReplayFrame:
        """
        
        :return: 
        """
    @property
    def StartFrame(self) -> ManiaReplayFrame:
        """
    ...
    def ToString(self) -> str:
        """"""
class ManiaReplayFrame(ReplayFrame, IConvertibleReplayFrame):
    """"""
    Actions: Final[List[ManiaAction]] = ...
    """
    ...
    def __init__(self):
        """"""
    @overload
    def __init__(self, time: float, actions: Array[ManiaAction]):
        """
    ...
    def Equals(self, obj: object) -> bool:
        """"""
    def FromLegacy(self, legacyFrame: LegacyReplayFrame, beatmap: IBeatmap, lastFrame: ReplayFrame = ...) -> None:
        """
