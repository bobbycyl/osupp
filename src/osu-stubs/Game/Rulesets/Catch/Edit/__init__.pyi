...
from osu.Game.Rulesets.Catch.UI import CatchPlayfield
from osu.Game.Rulesets.Catch.UI import DrawableCatchRuleset
...
from osu.Game.Rulesets.UI.Scrolling import ScrollingHitObjectContainer
...
class BananaShowerCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class CatchBeatSnapGrid(BeatSnapGrid, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ...
    """"""
class CatchBeatmapVerifier(Object, IBeatmapVerifier):
    """"""
    def __init__(self):
        """"""
    def Equals(self, obj: object) -> bool:
    ...
    def ToString(self) -> str:
        """"""
class CatchBlueprintContainer(ComposeBlueprintContainer, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[PlatformAction], IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ...
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, composer: CatchHitObjectComposer):
        """
    ...
    def Colour(self, value: ColourInfo) -> None: ...
    @property
    def Composer(self) -> CatchHitObjectComposer:
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class CatchDistanceSnapGrid(CompositeDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, velocities: Array[float]):
        """
    ...
    def StartX(self) -> float:
        ...
        """
    @StartX.setter
    def StartX(self, value: float) -> None: ...
    @property
    def Time(self) -> FrameTimeInfo:
        """"""
    @property
    ...
    def GetHashCode(self) -> int:
        """"""
    def GetSnappedPosition(self, screenSpacePosition: Vector2) -> SnapResult:
        """
...
class CatchDistanceSnapProvider(ComposerDistanceSnapProvider, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], IScrollBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache, IDistanceSnapProvider):
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class CatchEditorPlayfield(CatchPlayfield, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IPooledHitObjectProvider, IPooledSampleProvider):
    """"""
    ...
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, difficulty: IBeatmapDifficultyInfo):
        """
    ...
    """"""
class CatchEditorPlayfieldAdjustmentContainer(PlayfieldAdjustmentContainer, ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class CatchHitObjectComposer(ScrollingHitObjectComposer[CatchHitObject], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache, IPlacementHandler):
    """"""
    DISTANCE_SNAP_RADIUS: Final[ClassVar[float]] = ...
    """
    ...
    :return: 
    """
    def __init__(self, ruleset: CatchRuleset):
        """
    ...
    def TriggerEvent(self, e: UIEvent) -> bool:
        """"""
    def TryDistanceSnap(self, screenSpacePosition: Vector2) -> SnapResult:
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class CatchHitObjectInspector(HitObjectInspector, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, snapProvider: CatchDistanceSnapProvider):
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class CatchHitObjectUtils(ABC, Object):
    """"""
    def Equals(self, obj: object) -> bool:
        """"""
    def GetHashCode(self) -> int:
    ...
    @classmethod
    @overload
    def GetPositionRange(cls, hitObjects: IEnumerable[HitObject]) -> PositionRange:
        """
    ...
    @classmethod
    @overload
    def GetPositionRange(cls, hitObject: HitObject) -> PositionRange:
        """
        ...
        """
    @classmethod
    def GetStartPosition(cls, hitObjectContainer: ScrollingHitObjectContainer, hitObject: CatchHitObject) -> Vector2:
        """
        
        :param hitObjectContainer: 
        :param hitObject: 
        :return: 
        """
    def GetType(self) -> Type:
    ...
    def ToString(self) -> str:
        """"""
class CatchSelectionHandler(EditorSelectionHandler, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IHasContextMenu, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[PlatformAction], IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
...
class DrawableCatchEditorRuleset(DrawableCatchRuleset, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache, IProvideCursor, IDrawableScrollingRuleset, ICanAttachHUDPieces):
    ...
    :return: 
    """
    TimeRangeMultiplier: Final[BindableDouble] = ...
    """
    ...
    @Y.setter
    def Y(self, value: float) -> None: ...
    def AddHitObject(self, hitObject: CatchHitObject) -> None:
        """
    ...
    def Contains(self, screenSpacePos: Vector2) -> bool:
        """"""
    def CreateDrawableRepresentation(self, h: CatchHitObject) -> DrawableHitObject[CatchHitObject]:
        """
    ...
    def RegisterForDependencyActivation(self, registry: IDependencyActivatorRegistry) -> None:
        """"""
    def RemoveHitObject(self, hitObject: CatchHitObject) -> bool:
        """
    ...
    RevertResult: EventType[Action[JudgementResult]] = ...
    """"""
class FruitCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class JuiceStreamCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class PositionRange(ValueType):
    """"""
    EMPTY: Final[ClassVar[PositionRange]] = ...
    """
    ...
    def Equals(self, obj: object) -> bool:
        """"""
    def GetFlippedPosition(self, x: float) -> float:
        """
    ...
    def ToString(self) -> str:
        """"""
    @classmethod
    def Union(cls, a: PositionRange, b: PositionRange) -> PositionRange:
        """
