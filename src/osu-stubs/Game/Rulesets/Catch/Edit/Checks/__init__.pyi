...
class CheckBananaShowerGap(Object, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    def ToString(self) -> str:
        """"""
    class IssueTemplateBananaShowerEndGap(CheckBananaShowerGap.IssueTemplateBananaShowerGap):
        """"""
        Check: Final[ICheck] = ...
        """
        ...
        def Colour(self) -> Colour4:
            ...
            :return: 
            """
        def Create(self, deltaTime: float, expectedDeltaTime: int, hitObjects: Array[HitObject]) -> Issue:
            """"""
        def Equals(self, obj: object) -> bool:
            """"""
        def GetHashCode(self) -> int:
        ...
        def ToString(self) -> str:
            """"""
    class IssueTemplateBananaShowerGap(ABC, IssueTemplate):
        """"""
        Check: Final[ICheck] = ...
        """
        ...
        def ToString(self) -> str:
            """"""
    class IssueTemplateBananaShowerStartGap(CheckBananaShowerGap.IssueTemplateBananaShowerGap):
        """"""
        Check: Final[ICheck] = ...
        """
...
class CheckCatchAbnormalDifficultySettings(CheckAbnormalDifficultySettings, ICheck):
    ...
    def ToString(self) -> str:
        """"""
class CheckCatchLowestDiffDrainTime(CheckLowestDiffDrainTime, ICheck):
    """"""
    def __init__(self):
        """"""
    @property
