...
class DefaultJudgementPiece(TextJudgementPiece, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IAnimatableJudgement):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, result: HitResult):
        """
    ...
    def FinishTransforms(self, propagateChildren: bool = ..., targetMember: str = ...) -> None:
        """"""
    def GetAboveHitObjectsProxiedContent(self) -> Drawable:
        """
    ...
    """"""
class DrawableJudgement(PoolableDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    ...
    def IsProxy(self) -> bool:
        """"""
    @property
    def JudgedHitObject(self) -> HitObject:
        """
    ...
    def PropagatePositionalInputSubTree(self) -> bool:
        """"""
    @property
    def ProxiedAboveHitObjectsContent(self) -> Drawable:
        """
    ...
    def RequestsFocus(self) -> bool:
        """"""
    @property
    def Result(self) -> JudgementResult:
        """
    ...
    def AddTransform(self, transform: Transform, customTransformID: Optional[int] = ...) -> None:
        """"""
    def Apply(self, result: JudgementResult, judgedObject: DrawableHitObject) -> None:
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class IAnimatableJudgement(ITransformable, IDrawable):
    """"""
    @property
    def Alpha(self) -> float:
        """"""
    ...
    def ToSpaceOfOtherDrawable(self, input: Vector2, other: IDrawable) -> Vector2:
        """"""
class IgnoreJudgement(Judgement):
    """"""
    def __init__(self):
        """"""
    @property
...
class JudgementResult(Object):
    ...
    def ToString(self) -> str:
        """"""
class TextJudgementPiece(ABC, CompositeDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
