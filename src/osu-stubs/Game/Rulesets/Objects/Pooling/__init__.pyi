...
from osu.Framework.Graphics.Pooling import PoolableDrawable
...
from osu.Framework.Lists import SlimReadOnlyDictionaryWrapper
...
from osu.Game.Rulesets.Objects import HitObjectLifetimeEntry
...
T = TypeVar("T")
TDrawable = TypeVar("TDrawable")
TEntry = TypeVar("TEntry")
class EventType(Generic[T]):
    def __iadd__(self, other: T): ...
    def __isub__(self, other: T): ...
class HitObjectEntryManager(Object):
    """"""
    def __init__(self):
        """"""
    @property
    def AllEntries(self) -> IEnumerable[HitObjectLifetimeEntry]:
        """
        
        :return: 
        """
    def Add(self, entry: HitObjectLifetimeEntry, parent: HitObject) -> None:
        """
    ...
    def GetType(self) -> Type:
        """"""
    def Remove(self, entry: HitObjectLifetimeEntry) -> bool:
        """
    ...
    def ToString(self) -> str:
        """"""
    def TryGet(self, hitObject: HitObject, entry: HitObjectLifetimeEntry) -> Tuple[bool, HitObjectLifetimeEntry]:
        """
        ...
        :return: 
        """
    def __delitem__(self, entry: HitObjectLifetimeEntry) -> bool:
        """
        
        :param entry: 
        :return: 
        """
    OnEntryAdded: EventType[Action[HitObjectLifetimeEntry, HitObject]] = ...
    """"""
    OnEntryRemoved: EventType[Action[HitObjectLifetimeEntry, HitObject]] = ...
    """"""
class PoolableDrawableWithLifetime(ABC, Generic[TEntry], PoolableDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ...
    def EdgeEffect(self) -> EdgeEffectParameters:
        """"""
    @property
    def Entry(self) -> TEntry:
        """
        
        :return: 
        """
    @Entry.setter
    def Entry(self, value: TEntry) -> None: ...
    @property
    ...
    def AddTransform(self, transform: Transform, customTransformID: Optional[int] = ...) -> None:
        """"""
    def Apply(self, entry: TEntry) -> None:
        """
    ...
    """"""
class PooledDrawableWithLifetimeContainer(ABC, Generic[TEntry, TDrawable], CompositeDrawable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    AliveEntries: Final[SlimReadOnlyDictionaryWrapper[TEntry, TDrawable]] = ...
    """
    ...
    def EdgeEffect(self) -> EdgeEffectParameters:
        """"""
    @property
    def Entries(self) -> IEnumerable[TEntry]:
        """
    ...
    @Y.setter
    def Y(self, value: float) -> None: ...
    def Add(self, entry: TEntry) -> None:
        """
    ...
    def RegisterForDependencyActivation(self, registry: IDependencyActivatorRegistry) -> None:
        """"""
    def Remove(self, entry: TEntry) -> bool:
        """
    ...
    def __contains__(self, screenSpacePos: Vector2) -> bool:
        """"""
    def __delitem__(self, entry: TEntry) -> bool:
        """
