...
class TaikoBeatmap(Beatmap[TaikoHitObject], IBeatmap, IBeatmap[TaikoHitObject]):
    """"""
    def __init__(self):
        """"""
    @property
    ...
    @property
    def HitObjects(self) -> List[TaikoHitObject]:
        """
        
        :return: 
        """
    @HitObjects.setter
    def HitObjects(self, value: List[TaikoHitObject]) -> None: ...
    @property
    ...
    def Clone(self) -> Beatmap[TaikoHitObject]:
        """
    ...
    def ToString(self) -> str:
        """"""
class TaikoBeatmapConverter(BeatmapConverter[TaikoHitObject], IBeatmapConverter):
    """"""
    VELOCITY_MULTIPLIER: Final[ClassVar[float]] = ...
    """
    ...
    def GetType(self) -> Type:
        """"""
    @classmethod
    def RequiredSwellHitsPerSecond(cls, overallDifficulty: float) -> float:
        """
