...
from osu.Game.Rulesets.Taiko import TaikoInputManager
from osu.Game.Rulesets.Taiko import TaikoRuleset
from osu.Game.Rulesets.Taiko.UI import DrawableTaikoRuleset
from osu.Game.Rulesets.Taiko.UI import TaikoPlayfield
from osu.Game.Rulesets.Timing import MultiplierControlPoint
...
class DrawableTaikoEditorRuleset(DrawableTaikoRuleset, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache, IProvideCursor, IDrawableScrollingRuleset, ISupportConstantAlgorithmToggle, ICanAttachHUDPieces):
    ...
    :return: 
    """
    LockPlayfieldAspectRange: Final[BindableBool] = ...
    """
    ...
    def IsProxy(self) -> bool:
        """"""
    @property
    def KeyBindingInputManager(self) -> TaikoInputManager:
        """
    ...
    def Time(self) -> FrameTimeInfo:
        """"""
    @property
    def TimeRange(self) -> BindableDouble:
        """
    ...
    def AddHitObject(self, hitObject: TaikoHitObject) -> None:
        """
    ...
    def Contains(self, screenSpacePos: Vector2) -> bool:
        """"""
    def ControlPointAt(self, time: float) -> MultiplierControlPoint:
        """
        
        :param time: 
        :return: 
        """
    def CreateDrawableRepresentation(self, h: TaikoHitObject) -> DrawableHitObject[TaikoHitObject]:
        """
    ...
    def RegisterForDependencyActivation(self, registry: IDependencyActivatorRegistry) -> None:
        """"""
    def RemoveHitObject(self, hitObject: TaikoHitObject) -> bool:
        """
    ...
    """"""
class DrumRollCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class HitCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class SwellCompositionTool(CompositionTool):
    """"""
    Name: Final[str] = ...
    """
    ...
    def ToString(self) -> str:
        """"""
class TaikoBeatSnapGrid(BeatSnapGrid, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class TaikoBeatmapVerifier(Object, IBeatmapVerifier):
    """"""
    def __init__(self):
        """"""
    def Equals(self, obj: object) -> bool:
...
class TaikoBlueprintContainer(ComposeBlueprintContainer, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[PlatformAction], IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    ...
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, composer: TaikoHitObjectComposer):
        """
    ...
    def Colour(self, value: ColourInfo) -> None: ...
    @property
    def Composer(self) -> TaikoHitObjectComposer:
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class TaikoEditorPlayfield(TaikoPlayfield, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IPooledHitObjectProvider, IPooledSampleProvider):
    """"""
    ...
    def Remove(self, h: DrawableHitObject) -> bool:
        ...
        """
    @overload
    def Remove(self, h: HitObject) -> bool:
        """
    ...
    def __delitem__(self, h: DrawableHitObject) -> bool:
        ...
        """
    @overload
    def __delitem__(self, h: HitObject) -> bool:
        """
    ...
    RevertResult: EventType[Action[JudgementResult]] = ...
    """"""
class TaikoHitObjectComposer(ScrollingHitObjectComposer[TaikoHitObject], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IPlacementHandler):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
...
class TaikoSelectionHandler(EditorSelectionHandler, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IHasContextMenu, ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[PlatformAction], IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    ...
    def SetNewCombo(self, state: bool) -> None:
        ...
        :param state: 
        """
    def SetRimState(self, state: bool) -> None:
        """
    ...
    def SetSampleBank(self, bankName: str) -> None:
        ...
        :param bankName: 
        """
    def SetStrongState(self, state: bool) -> None:
        """
