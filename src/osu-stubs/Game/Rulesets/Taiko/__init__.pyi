...
class TaikoAction(Enum):
    """"""
    LeftRim: TaikoAction = ...
    """"""
    LeftCentre: TaikoAction = ...
    """"""
    RightCentre: TaikoAction = ...
    """"""
    RightRim: TaikoAction = ...
    """"""
class TaikoInputManager(RulesetInputManager[TaikoAction], ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IInputStateChangeHandler, IFocusManager, IRequireHighFrequencyMousePosition, ISourceGeneratedHandleInputCache, ICanAttachHUDPieces, IHasRecordingHandler, IHasReplayHandler):
    """"""
    CurrentState: Final[InputState] = ...
    """"""
    KeyBindingContainer: Final[KeyBindingContainer[TaikoAction]] = ...
    """
    ...
    """"""
class TaikoRuleset(Ruleset, ILegacyRuleset):
    """"""
    ...
    def ToString(self) -> str:
        """"""
class TaikoSettingsSubsection(RulesetSettingsSubsection, ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], IFillFlowContainer, IFilterable, IHasFilterTerms, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ProcessCustomClock: Final[bool] = ...
    """"""
    def __init__(self, ruleset: TaikoRuleset):
        """
    ...
    OnUpdate: EventType[Action[Drawable]] = ...
    """"""
class TaikoSkinComponentLookup(SkinComponentLookup[TaikoSkinComponents], ISkinComponentLookup):
    """"""
    Component: Final[TaikoSkinComponents] = ...
    """
    
    :return: 
    """
    def __init__(self, component: TaikoSkinComponents):
        """
    ...
    def ToString(self) -> str:
        """"""
class TaikoSkinComponents(Enum):
    """"""
    InputDrum: TaikoSkinComponents = ...
    """"""
    ...
    """"""
    DrumRollTick: TaikoSkinComponents = ...
    """"""
    Swell: TaikoSkinComponents = ...
    """"""
    HitTarget: TaikoSkinComponents = ...
    """"""
    PlayfieldBackgroundLeft: TaikoSkinComponents = ...
    """"""
    PlayfieldBackgroundRight: TaikoSkinComponents = ...
    """"""
    BarLine: TaikoSkinComponents = ...
    """"""
    TaikoExplosionMiss: TaikoSkinComponents = ...
    """"""
    TaikoExplosionOk: TaikoSkinComponents = ...
    """"""
    TaikoExplosionGreat: TaikoSkinComponents = ...
    """"""
    TaikoExplosionKiai: TaikoSkinComponents = ...
    """"""
    Scroller: TaikoSkinComponents = ...
    """"""
    Mascot: TaikoSkinComponents = ...
    """"""
    KiaiGlow: TaikoSkinComponents = ...
    """"""
    DrumSamplePlayer: TaikoSkinComponents = ...
    """"""