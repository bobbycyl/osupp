...
from osu.Game.Rulesets.Osu.HUD.AimErrorMeter import MarkerStyle
from osu.Game.Rulesets.Osu.HUD.AimErrorMeter import PositionDisplay
from osu.Game.Screens.Play.HUD.HitErrorMeters import HitErrorMeter
from osu.Game.Skinning import ISerialisableDrawable
...
class AimErrorMeter(HitErrorMeter, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, ISerialisableDrawable):
    """"""
    Name: Final[str] = ...
    """"""
    ...
    def AutoSizeEasing(self) -> Easing:
        """"""
    @property
    def AverageMarkerSize(self) -> BindableNumber[float]:
        """
        
        :return: 
        """
    @property
    def AverageMarkerStyle(self) -> Bindable[AimErrorMeter.MarkerStyle]:
        """
    ...
    @property
    def HitMarkerSize(self) -> BindableNumber[float]:
        """
        
        :return: 
        """
    @property
    def HitMarkerStyle(self) -> Bindable[AimErrorMeter.MarkerStyle]:
        """
    ...
    @property
    def PositionDisplayStyle(self) -> Bindable[AimErrorMeter.PositionDisplay]:
        """
    ...
    def Transforms(self) -> IEnumerable[Transform]:
        """"""
    @property
    def UsesFixedAnchor(self) -> bool:
        """
        
        :return: 
        """
    @UsesFixedAnchor.setter
    def UsesFixedAnchor(self, value: bool) -> None: ...
    @property
    ...
    def Contains(self, screenSpacePos: Vector2) -> bool:
        """"""
    def CopyAdjustedSetting(self, target: IBindable, source: object) -> None:
        """
    ...
    class MarkerStyle(Enum):
        ...
        Plus: MarkerStyle = ...
        """"""
    class PositionDisplay(Enum):
        """"""
        Absolute: PositionDisplay = ...
        """"""
        Normalised: PositionDisplay = ...
        """"""