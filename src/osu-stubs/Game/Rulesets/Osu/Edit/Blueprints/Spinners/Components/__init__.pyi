...
class SpinnerPiece(BlueprintPiece[Spinner], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache):
    """"""
    Name: Final[str] = ...
    """"""
    ...
    def TriggerEvent(self, e: UIEvent) -> bool:
        """"""
    def UpdateFrom(self, hitObject: Spinner) -> None:
        """
