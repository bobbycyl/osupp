...
class SpinnerPlacementBlueprint(HitObjectPlacementBlueprint, ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], ITransformable, IDrawable, IKeyBindingHandler, IKeyBindingHandler[GlobalAction], ISourceGeneratedHandleInputCache):
    """"""
    ...
    """"""
class SpinnerSelectionBlueprint(OsuSelectionBlueprint[Spinner], IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, ITransformable, IDrawable, ISourceGeneratedHandleInputCache, IStateful[SelectionState]):
    """"""
