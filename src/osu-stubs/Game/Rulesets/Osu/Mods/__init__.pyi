...
class InputBlockingMod(ABC, Mod, IEquatable[IMod], IEquatable[Mod], IApplicableMod, IApplicableToDrawableRuleset[OsuHitObject], IMod, IUpdatableByPlayfield, IDeepCloneable[Mod]):
    ...
    def Update(self, playfield: Playfield) -> None:
        ...
        :param playfield: 
        """
class MaxSizeComboSlider(RoundedSliderBar[Int32], ICollection[Drawable], IEnumerable[Drawable], IReadOnlyCollection[Drawable], IReadOnlyList[Drawable], IEnumerable, IDisposable, IDependencyInjectionCandidate, ISourceGeneratedDependencyActivator, ISourceGeneratedLongRunningLoadCache, IContainer, IContainerCollection[Drawable], IContainerEnumerable[Drawable], IHasTooltip, ITooltipContentProvider, ITransformable, IHasCurrentValue[Int32], IDrawable, ISourceGeneratedHandleInputCache):
    """"""
...
class OsuModDoubleTime(ModDoubleTime, IEquatable[IMod], IEquatable[Mod], IApplicableMod, IApplicableToAudio, IApplicableToRate, IApplicableToSample, IApplicableToTrack, IMod, IDeepCloneable[Mod]):
    ...
    def ToString(self) -> str:
        """"""
class OsuModEasy(ModEasyWithExtraLives, IEquatable[IMod], IEquatable[Mod], IApplicableFailOverride, IApplicableMod, IApplicableToDifficulty, IApplicableToHealthProcessor, IApplicableToPlayer, IMod, IDeepCloneable[Mod]):
    """"""
    def __init__(self):
        """"""
    @property
